		...
		<Fragment>
			<SimpleBar style={{ maxHeight: '100vh' }}>
				<div className="nav-scroller">
					<Link href="/" className="navbar-brand w-25">
						<Image src="/header/logo.svg" alt="" />
					</Link>
				</div>				
				{/* Dashboard Menu */}
						...
						if (menu.grouptitle) {
							return (
								<Card bsPrefix="nav-item" key={index}>
									{/* group title item */}
									<div className="navbar-heading fs-12">{menu.title}</div>
							...
							if (menu.children) {
								...
								return (
									<Card bsPrefix="nav-item" key={index}>
										...
										<Link href={menu.link} className={`nav-link ${location === menu.link ? 'active' : ''} fs-14`}>
